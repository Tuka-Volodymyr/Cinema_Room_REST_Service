...
public class Statistics {
    ...
    public Statistics(Cinema cinema){
        this.current_income=cinema.getTotalIncome();
        this.number_of_available_seats=cinema.getSeatIs().size();
        this.number_of_purchased_tickets=cinema.getPurchasedTickets().size();
    }
